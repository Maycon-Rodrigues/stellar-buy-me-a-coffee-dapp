...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBLX7FASEAQCOYPEVZN2ZUTOK2AWJAD7BYE5HFTQPAJGESOPFFIOFWAT";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_token_address: (json: string) => AssembledTransaction<string>;
        get_balance: (json: string) => AssembledTransaction<Result<bigint, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        get_supporters: (json: string) => AssembledTransaction<Result<Supporter[], import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        buy_coffee: (json: string) => AssembledTransaction<Result<void, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
